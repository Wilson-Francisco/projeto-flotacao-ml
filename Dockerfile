...
# Instala dependências do sistema operacional necessárias para o XGBoost e ferramentas de build
RUN apt-get update && apt-get install -y --no-install-recommends \
    build-essential \
    && rm -rf /var/lib/apt/lists/*

# Copia primeiro apenas o arquivo de dependências
...
COPY src/ ./src/
COPY mlruns/ ./mlruns/
# Nota: Copiamos a pasta mlruns para que o container leve o modelo de 91.3% junto com ele

# Cria um usuário comum para rodar a aplicação 
